...
export const state: NationalState = {
	nationalAverages: undefined
}

export const getters = {
	nationalAverageGhg(state: NationalState) {
...
export const actions = {
	fetchNationalAverages({ commit }: any) {
...
export const mutations = {
	setNationalAverages(state: NationalState, nationalAverages: any) {
